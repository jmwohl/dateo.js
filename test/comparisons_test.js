	...
	describe('isBefore', function () {
		it('fails if Dateo instance not passed as arg', function () {
			try {
				...
				assert.strictEqual(error.toString(), 'Error: isBefore must take another Dateo as an argument')
			}
		})
	...
	describe('isAfter', function () {
		it('fails if Dateo instance not passed as arg', function () {
			try {
				...
				assert.strictEqual(error.toString(), 'Error: isAfter must take another Dateo as an argument')
			}
		})
	...
	describe('isSame', function () {
		it('fails if Dateo instance not passed as arg', function () {
			try {
				...
				assert.strictEqual(error.toString(), 'Error: isSame must take another Dateo as an argument')
			}
		})
